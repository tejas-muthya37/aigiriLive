...
const productsArray = [{id:"1",
    ...
    image:holige,
    price:"96",
    desc: "Holige is a popular sweet flatbread made with flour, lentils, jaggery and cardamoms. It is a festive delicacy and is made during Deepavali, Holi and Ganesha Chaturthi. Tastes best with Ghee or Milk.",
    length: "10",
    breadth: "10",
    height: "10",
    weight: "2"}, {id:"12",
